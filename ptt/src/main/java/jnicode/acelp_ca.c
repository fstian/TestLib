...
static void Cor_h(
     ...
     s16 *rr         /* (o)     :Correlations of H[]         */
);
static s16 D4i40_17_fast(/*(o) : Index of pulses positions.               */
  s16 dn[],          /* (i)    : Correlations between h[] and Xn[].       */
  s16 *rr,           /* (i)    : Correlations of impulse response h[].    */
  s16 h[],           /* (i) Q12: Impulse response of filters.             */
  s16 cod[],         /* (o) Q13: Selected algebraic codeword.             */
  s16 y[],           /* (o) Q12: Filtered algebraic codeword.             */
...
{
  s16 *rri0i0, *rri1i1, *rri2i2, *rri3i3, *rri4i4;
  s16 *rri0i1, *rri0i2, *rri0i3, *rri0i4;
  s16 *rri1i2, *rri1i3, *rri1i4;
  s16 *rri2i3, *rri2i4;

  s16 *p0, *p1, *p2, *p3, *p4;

  s16 *ptr_hd, *ptr_hf, *ptr_h1, *ptr_h2;
  l32 cor;
  s16 i, k, ldec, l_fin_sup, l_fin_inf;
  s16 h[L_SUBFR];
...
{
  s16 i0, i1, i2, i3, ip0, ip1, ip2, ip3;
  s16 i, j, ix, iy, track, trk, max;
  s16 prev_i0, i1_offset;
  s16 psk, ps, ps0, ps1, ps2, sq, sq2;
  s16 alpk, alp, alp_16;
  l32 s, alp0, alp1, alp2;
  s16 *p0, *p1, *p2, *p3, *p4;
  s16 sign_dn[L_SUBFR], sign_dn_inv[L_SUBFR], *psign;
  s16 tmp_vect[NB_POS];
  s16 *rri0i0, *rri1i1, *rri2i2, *rri3i3, *rri4i4;
  s16 *rri0i1, *rri0i2, *rri0i3, *rri0i4;
  s16 *rri1i2, *rri1i3, *rri1i4;
