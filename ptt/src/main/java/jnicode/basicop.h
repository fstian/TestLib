...
s16 round_linux(l32 L_var1);              /* Round,               1 */
...
s16 mult_r(s16 var1, s16 var2);  /* Mult with round_linux,     2 */
l32 L_shl(l32 L_var1, s16 var2); /* Long shift left,     2 */
l32 L_shr(l32 L_var1, s16 var2); /* Long shift right,    2 */
s16 shr_r(s16 var1, s16 var2);/* Shift right with round_linux, 2 */
...
l32 L_shr_r(l32 L_var1, s16 var2);/* Long shift right with round_linux,3*/
...
double inttofloat( //returnvalue: 转换后的浮点数
