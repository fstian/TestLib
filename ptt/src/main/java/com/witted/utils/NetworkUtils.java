...
public class NetworkUtils {
     ...
     * @return int
     */
    public static int getWifiInfoRssi(Context context) {
    ...
    public static boolean getNetworkTypeIsWifi(Context context, Network network) {
    ...
    public static boolean getNetworkTypeIsEthernet(Context context, Network network) {
        ConnectivityManager connectMgr = (ConnectivityManager) context.getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
        NetworkCapabilities networkCapabilities = connectMgr.getNetworkCapabilities(network);
    ...
    public static void openWirelessSettings(Context context) {
        context.startActivity(new Intent("android.settings.WIFI_SETTINGS").setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
     ...
     * @return boolean
     */
    public static boolean toastNetworkState(Context context) {
